...
DEFAULT_ONNX_EXPORT_DIR = "/data/RL/RL_sim2sim_mujoco/actor/yuntai"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--out",
        type=str,
        default=DEFAULT_ONNX_EXPORT_DIR,
        help="Output ONNX path or directory",
    )
    ...
    onnx_path = args.out
    if os.path.isdir(onnx_path) or not onnx_path.endswith(".onnx"):
        onnx_path = os.path.join(onnx_path, "policy.onnx")
